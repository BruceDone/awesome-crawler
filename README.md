...
* [Crawling Framework](https://github.com/tokenmill/crawling-framework) - A GUI management and execution tool to make running [StormCrawler](http://github.com/DigitalPebble/storm-crawler/) easy.
